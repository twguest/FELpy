...
"""
Job Batch File Submission Script for NKB Energy Statistics Analysis
"""
...
log_dir = "/gpfs/exfel/data/user/guestt/spb_model/logs/NanoKB/analysis/"
...
for fname in f:
    ...
    with open(job_file, "w+") as fh:
        ...
        fh.writelines("python /gpfs/exfel/data/user/guestt/spb_model/model/analysis/extractEnergyData.py {}\n".format(fname) )
