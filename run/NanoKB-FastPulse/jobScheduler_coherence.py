...
log_dir = "/gpfs/exfel/data/user/guestt/spb_model/logs/coherence/"
...
for fname in F:
    ...
    with open(job_file, "w+") as fh:
        ...
        fh.writelines("python /gpfs/exfel/data/user/guestt/spb_model/model/analysis/coherence.py {}".format(fname) )
